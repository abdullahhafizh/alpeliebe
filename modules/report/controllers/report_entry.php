...
class Report_entry extends AdminController {  
	function __construct()    
	{
		...
		$this->_set_title('Report Data Entry');
	...
	function search(){
		...
		if($this->input->post('print_excel')){
			...
			$cetak = $this->M->report_entry($par_filter);
...
//			debugCode($this->_v);
			...
			$this->data_table = $this->M->report_entry($par_filter);
			$data = $this->_data(array(
					"base_url"	=> $this->own_link.'/index'
			));
				$data['param'] = array(

        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="row form-group">  
              ...
              <div class="col-md-7">
               <input type="text" id="user_fullname" name="user_fullname" class="form-control" value="<?php echo isset($val->user_fullname)?$val->user_fullname:'';?>" />
              </div>
            </div> 
            ...
            <div class="row form-group">
              ...
              <div class="col-md-7">
                <input type="text" id="user_email" name="user_email" class="form-control" value="<?php echo isset($val->user_email)?$val->user_email:'';?>" />
              </div> 
            </div> 
            ...
            <div class="row form-group">
              ...
              <div class="col-md-7">
            <input type="text" class="form-control" id="user_name" value="<?php echo isset($val->user_name)?$val->user_name:'';?>" name="user_name" />
              <div id="status"></div>
              </div> 
            </div> 
            <div class="row form-group">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-7">
                   ...
                   <input type="password" id="user_password2" name="user_password2" class="form-control"  value="" />
              <div id="status_p"></div>
              </div> 
            </div> 

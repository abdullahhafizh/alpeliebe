  ...
  <div class="panel-body">
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <div class="panel" style="height:370px;padding:10px;" id="cart_bar_by_prov"></div>
      </div>
    </div>
              ...
              <table class="table table-hover table-bordered table-striped">
                <tbody>
                  <tr>
                    ...
                    <td align="right"><b><b><?php //echo myNum(get_total_pengusul($pengusul));?></b></td>
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="panel" style="height:370px;padding:10px;" id="cart_line_anggota"></div>
      </div>
          ...
          <div class="panel-body panel-body-table" style="height: 300px; overflow-y:">
						<div class="table-responsive">
							<table class="table table-hover table-bordered table-striped">
							   <thead>
                   <?php
                    //foreach ((array)get_total_peng($pengusul) as $p => $q) {
                  ?>
                  <tr>
                    <td>Jumlah Data Ter-upload (Scan)</td>
                    <td><?php echo myNum($q->data_upload);?></td>
                  </tr>
                  <tr>
                    <td>Jumlah Data Ter-entry (Entry)</td>
                    <td><?php echo myNum($q->data_entry);?></td>
                  </tr>
                  <tr>
                    <td>Jumlah Data Reject</td>
                    <td><?php echo myNum($q->data_reject_entry+$q->data_reject_scan);?></td>
                  </tr>
                  <tr>
                    <td>Jumlah Data Approve (Siap Cetak)</td>
                    <td><?php echo myNum($q->data_approve);?></td>
                  </tr>
                  <tr>
                    <th>TOTAL DATA</th>
                    <td><b><?php echo myNum($q->data_total);?></b></td>
                  </tr>
                  <tr>
                    <td>Jumlah Kartu Belum Tercetak</td>
                    <td><?php echo myNum($q->belum_cetak);?></td>
                  </tr>
                  <tr>
                    <td>Jumlah Kartu Tercetak</td>
                    <td><?php echo myNum($q->tercetak);?></td>
                  </tr>
                  <tr>
                    <th>TOTAL DATA</th>
                    <td><b><?php echo myNum($q->data_total);?></b></td>
...
$(function () {
    ...
    $('#cart_line_anggota').highcharts({
        ...
        subtitle: {
            text: '<b>Grafik Upload Data KTA 30 Hari Terakhir Provinsi <?php echo $prop_nama;?></b>'
        },
        plotOptions: {
            column : {
                pointWidth:23
...
chart: {
    ...
    $('#cart_bar_by_prov').highcharts({
        ...
        subtitle: {
            text: '<b>Jumlah Anggota Berdasarkan Jenis Kelamin Per Kabupaten / Kota Provinsi <?php echo $prop_nama;?></b>'
        },
        plotOptions: {
            column : {
                pointWidth:23

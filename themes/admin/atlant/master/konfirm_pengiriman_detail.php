                    ...
                    <h3>Data Order</h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="1">:</td>
                                <td><?php echo $val->order_acc_date;?></td>
                            </tr>
                            <tr>
                                <td>Jumlah Kartu</td>
                                <td width="1">:</td>
                            ...
                            <tr>
                                ...
                                <td width="400">
									<div class="input-group">
										...
										<input type="text" id="resi" name="resi" class="validate[required] form-control" value="<?php echo isset($val->order_resi)?$val->order_resi:'';?>" />
									</div>								
								</td>
                            </tr>
                            <tr>

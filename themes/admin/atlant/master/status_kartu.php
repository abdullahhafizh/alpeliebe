...
<div class="panel panel-default tabs" style="margin-top:25px;">
    <ul class="nav nav-tabs" role="tablist" style="border-bottom:2px solid #F5F5F5;">
        <li <?php echo isset($this->jCfg['page_tab'])&&$this->jCfg['page_tab']==1?'class="active"':'';?>><a href="<?php echo $own_links."/set_tab?tab=1&next=".current_url();?>"><i class="fa fa-credit-card"></i> Anggota Aktif</a></li>
        <li <?php echo isset($this->jCfg['page_tab'])&&$this->jCfg['page_tab']==2?'class="active"':'';?> ><a href="<?php echo $own_links."/set_tab?tab=2&next=".current_url();?>"><i class="fa fa-credit-card"></i> Anggota Non Aktif</a></li>
    </ul>

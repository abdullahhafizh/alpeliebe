...
<div class="panel panel-default tabs" style="margin-top:25px;">
    <ul class="nav nav-tabs" role="tablist" style="border-bottom:2px solid #F5F5F5;">
        <li class="pull-right"><input type="submit" name="bayar_collective" value="Cek Status Asuransi" class="btn btn-success" ></li>
    </ul>
            ...
            <table class="table table-hover table-bordered table-striped">
               <thead>
                ...
                <tr>
                    ...
                    <th>Tanggal Cek Status Terakhir</th>
                </tr>
                <?php } ?>
                </thead>
               <tbody> 
                ...
                if(count($data) > 0){
                    ...
                    foreach($data as $r){
                        ...
                        <tr>
                            ...
                            <td><?php echo $r->kta_certificateNumber;?></td>
                            ...
                            <td><?php echo myDate($r->kta_check_date,"d M Y",false);?></td>
                        </tr>
                <?php } 
                }
                ?>

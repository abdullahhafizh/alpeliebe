        ...
        <div class="table-responsive">
            <table class="table datatable">
               <thead>
                <tr>
                    <th width="30px">No</th>
                    <th width="300px">Propinsi</th>
                    <th width="300px">Kabupaten</th>
               ...
               <tbody> 
                ...
                if(count($data) > 0){
                    ...
                    foreach($data as $r){
                        ...
                        ?>
                        <?php if($prov != $r->kec_kab_id){?>
<!--                        <tr>
                            <td colspan="3"><b><?php echo $r->kec_kab_id." - ".$r->propinsi_nama." - ".$r->kab_nama;?></b></td>
                        </tr>
-->
                        <?php }  $prov = $r->kec_kab_id; ?>
                        <tr>
                            <td><?php echo ++$no;?></td>
                            <td><?php echo $r->kab_propinsi_id." - ".$r->propinsi_nama;?></td>
                            <td><?php echo substr($r->kec_kab_id,2,2)." - ".$r->kab_nama;?></td>
                            <td><?php echo substr($r->kec_kode,4,2);?></td>
                            <td><?php echo $r->kec_nama;?></td>
                            <td align="right">
                                <?php link_action($links_table_item,"?_id="._encrypt($r->kec_id));?>
                            </td>
                        </tr>
                <?php } 
                }

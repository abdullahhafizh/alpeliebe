...
?>
    ...
    <form id="form-validated" enctype="multipart/form-data" action="<?php echo $own_links;?>/save_suket_detail" class="form-horizontal" method="post"> 
        <input type="hidden" name="kta_id" id="kta_id" value="<?php echo isset($val->kta_id)?$val->kta_id:'';?>" />
        <input type="hidden" name="kta_ktp" id="kta_ktp" value="<?php echo isset($val->kta_no_suket)?$val->kta_no_suket:'';?>" />
        ...
        <div class="panel-body">                                                                        
			...
			<img alt="" src="<?php echo base_url()."assets/collections/kta/medium/".$val->kta_lampiran1;?>" style="height:100%;width:100%;" >
			 </div>                
             <div class="col-md-4" style="border:1px solid #000;">
			<img alt="" src="<?php echo base_url()."assets/collections/kta/medium/".$val->kta_lampiran2;?>" style="height:100%;width:100%;" >
			 </div>                				
             <div class="col-md-4" style="border:1px solid #000;">
			<img alt="" src="<?php echo base_url()."assets/collections/kta/medium/".$val->kta_lampiran3;?>" style="height:100%;width:100%;" >
			 </div>                				
			 </div>

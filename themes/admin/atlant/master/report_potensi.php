...
$(function () {
    ...
    $('#cart_pie_gender').highcharts({
        ...
        subtitle: {
            text: '<b>Anggota Berdasarkan Omzet</b>'
        },
        tooltip: {
            pointFormat: '{point.y:.f}'
        },
        ...
        series: [{
            ...
            data: [
                <?php 
                foreach ((array)get_pie_omzet() as $k => $v) {
                   echo $k==0?"":",";
                   echo "['".$omzet[$v->nama]."',".$v->jumlah."]";
                }?>
            ]
        }]
    });
    ...
    $('#cart_bar_by_prov').highcharts({
        ...
        series: [{
            name: 'Anggota',
            data: [<?php
              foreach ((array)get_cart_bisnis() as $p => $q) {
                echo $p>0?',':'';
    ...
    $('#cart_bar_by_kop').highcharts({
        ...
        subtitle: {
            text: '<b>Jumlah Koperasi Setiap Provinsi</b>'
        },
        plotOptions: {
            column : {
                pointWidth:23
        ...
        series: [{
            name: 'Anggota',
            data: [<?php
              foreach ((array)get_cart_koperasi() as $p => $q) {
                echo $p>0?',':'';
                echo "['".$q->nama."',".$q->jumlah."]";
              }
            ?>

                        ...
                        <tr>
                         ...
                         <tr>
                                <td colspan="3" align="center">
												...
												<img alt="" src="<?php echo get_image(base_url()."assets/collections/kta/original/".$val->col1);?>" width="200">
												<img alt="" src="<?php echo get_image(base_url()."assets/collections/kta/original/".$val->col2);?>" width="200">
												<?php }else{ ?>
												<img alt="" src="<?php echo $val->kta_foto_wajah;?>" width="150" >
												<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>												
												<img alt="" src="<?php echo $val->kta_foto_ktp;?>" width="330" >
												<?php } ?>
								</td>
                            </tr>
                        </tbody>
                    ...
                    <h3>Data Tambahan</h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="1">:</td>
                                <td><?php if($val->kta_pendidikan==0){ echo "-"; }else{ $pendidikan[$val->kta_pendidikan];};?></td>
                            </tr>
                            <tr>
                                <td>Pekerjaan</td>
                                <td width="1">:</td>
                            ...
                            <tr>
                                <td>No. HP</td>
                                <td width="1">:</td>
                                <td><?php echo $val->kta_hp." | No. Telp Rumah : ".$val->kta_telp;?></td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td width="1">:</td>
                            ...
                            <tr>
                                ...
                                <td width="1">:</td>
                                <td><?php if($val->kta_tingkatan==0){ echo "-"; }else{ $tingkat[$val->kta_tingkatan];}?></td>
                            </tr>
							<?php
						...
						?>
                            <tr>
                                ...
                                <td width="1">:</td>
                                <td><?php echo $val->kta_trikarya.", ".$val->kta_hastakarya;?></td>
                            </tr>
			                            <tr>
			                                <td colspan="3"><hr></td>
			                            </tr>
			                                ...
			                                <td colspan="3" align="center">
			                                	<div class="content">
													...
													<div style="clear:both;float:right;margin:3px 22px 0 0;">
														<img alt="" src="<?php echo empty($val->kta_foto_wajah)?base_url().'assets/images/no_photo.jpg':$val->kta_foto_wajah;?>" style="height:97px; width:74px;" >
													</div>

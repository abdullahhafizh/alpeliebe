            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">                                                                                            
                            <span class="help-block">Domisili mempengaruhi penomoran pada NPAPG, mohon isi dengan benar.</span>						
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">                                                                                            
                            <div class="alert alert-warning" role="alert">
                                ...
                                <strong>Perhatian!</strong> Isi dengan benar sesuai dengan formulir.
                            </div>                       
                        </div>
                    </div>
                    <?php
                        ...
                        <div class="col-md-6">                                                                                            
                            <div class="input-group">                                         
								...
								<select class="form-control" id="kta_tingkat" name="kta_tingkat">
                                    <option value="0"> - pilih tingkat kepengurusan	 - </option>
                    ...
                    <div class="form-group">
                        <div class="col-md-6">                                                                                            
                            <div class="input-group">                                         
                                <span class="input-group-addon"><i class="fa fa-map-marker"></i></span>
                                <select class="form-control" id="kta_hastakarya" name="kta_hastakarya">
                                    <option value="0"> - pilih keanggotaan hasta karya - </option>
                                    <?php foreach((array)cfg('hasta_karya') as $kj=>$vj){?>
                                    <option value="<?php echo $kj;?>" <?php echo isset($val)&&$val->kta_hastakarya==$kj?'selected="selected"':'';?> ><?php echo $vj;?></option>
                                    <?php } ?>
                                </select> 
                            </div>
                        </div>
                        ...
                        <div class="panel-body panel-body-table">
                            <div class="row">
                                <div class="col-md-12" style="padding: 10px">
                                    ...
                                    <div class="row">
										<div class="col-md-7">
											<div class="panel panel-default" id="panel-crop" style="opacity:0.2;">
				                                <div class="panel-heading">
						                            <div class="panel-title-box">
						                                <h3>Crop Photo</h3>
						                            </div>
										...
										<div class="col-md-5">
											<div class="panel panel-default" id="panel-result" style="opacity:0.2;">
				                                ...
				                                <div class="panel-footer">
				                                    <button type="button" id="btn-reset" class="btn btn-danger pull-right" disabled="disabled"><i class="fa fa-refresh"></i>Reset</button>
				                                </div>                            
				                            </div>										
										</div>
									</div>

<!-- <form action="" method="post" >
      <div class="well">
            <div class="row">
                ...
                <div class="col-md-2" style="margin-top:0px;">
                    <select class="form-control" id="kta_propinsi" name="kta_propinsi">
                        ...
                        <?php foreach ((array)get_propinsi() as $m) {
                          $s = isset($this->jCfg['search']['kta_propinsi'])&&$this->jCfg['search']['kta_propinsi']==$m->propinsi_id?'selected="selected"':'';
                ...
                <div class="col-md-2" style="margin-top:0px;">
                    <select class="form-control" id="kta_kelurahan" name="kta_kelurahan">
                    </select>
                </div>
                ...
                <table class="table table-hover table-bordered table-striped">
                   ...
                   <tbody> 
                    ...
                    foreach ((array)$wilayah as $key => $value) {
                        ...
                        echo "<td align='right'><b>".myNum(get_total_gender(2,$value->propinsi_id))."</b></td>";
                        ...
                        if(trim($this->jCfg['search']['type'])=="detail"){
                            ...
                            $jumlah_pria += myNum(get_total_gender(1,$value->propinsi_id));
                            $jumlah_wanita += myNum(get_total_gender(2,$value->propinsi_id));							
        ...
        series: [{
            ...
            data: [
                <?php foreach ((array)get_pie_status() as $k => $v) {
                   echo $k==0?"":",";
                   echo "['".$status_kta[$v->nama]."',".$v->jumlah."]";
                }?>
            ]
        }]
    });

                ...
                <div class="col-md-3">
					<div class="panel panel-default" style="margin-top:-10px;">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Daftar Jumlah Upload</h3>         
						...
						<div class="panel-body panel-body-table scroll" style="height:320px;">
							<div class="table-responsive">
                                ...
                                <div class="panel-footer"> 
                                        <span class="contacts-title"> Total Data Upload : <?php echo myNum($total);?></span>
                                </div>
					</div>
				</div>
                </div>
...
$(function () {
    ...
    $('#cart_line_anggota').highcharts({
        ...
        subtitle: {
            text: '<b>GRAFIK JUMLAH DATA UPLOAD 30 HARI TERAKHIR</b>'
        },
        plotOptions: {
            column : {
                pointWidth:23

				...
				<div class="row" id="form-link" style="display: none;">
					<div class="col-md-6">
						<div class="gallery" id="links">
							...
							<a class="gallery-item" href="<?php echo base_url().'assets/report/pdf/DataAnggota-'.date('dmy').'-1.pdf';?>" target="_blank" id="link-pdf" data-gallery style="display: none;">
								<div class="image">
...
//var URL_EXPORT_ZIP = '<?php echo $own_links;?>/export_zip';
</script>